...
const (
	// InteractiveMessageButton is the type of interactive message used for Reply Buttons.
	InteractiveMessageButton = "button"
	// InteractiveMessageList is the type of interactive message used for List Messages.
	InteractiveMessageList = "list"
	// InteractiveMessageProduct is the type of interactive message used for Single Product Messages.
	InteractiveMessageProduct = "product"
	// InteractiveMessageProductList is the type of interactive message used for Multi-Product Messages.
